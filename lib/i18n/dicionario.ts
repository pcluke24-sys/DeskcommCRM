...
export const DICIONARIO: Traducoes = {
  ...
  // ─── Recursos personalizados preservados na integração v1.45 ───
  ...
  "). Máximo: 366 dias. Entradas repetidas contam uma vez por lead em cada etapa.": { es: "). Máximo: 366 días. Las entradas repetidas cuentan una vez por lead en cada etapa." },
  ...
  "Selecione um período válido de até 366 dias.": { es: "Selecciona un período válido de hasta 366 días." },
  "Carregando histórico…": { es: "Cargando historial…" },
  "Não foi possível carregar o relatório. Clique em Atualizar para tentar novamente.": { es: "No se pudo cargar el informe. Haz clic en Actualizar para intentarlo de nuevo." },
  "Coleta iniciada:": { es: "Recopilación iniciada:" },
  "no primeiro novo registro": { es: "en el primer registro nuevo" },
  ". Nenhum histórico anterior foi recuperado.": { es: ". No se recuperó ningún historial anterior." },
  "Leads com atividade no período": { es: "Leads con actividad en el período" },
  "Leads com venda": { es: "Leads con venta" },
  "Ainda não há entradas registradas neste período. Crie ou mova um lead no Kanban e clique em Atualizar.": { es: "Todavía no hay entradas registradas en este período. Crea o mueve un lead en el Kanban y haz clic en Actualizar." },
  "Leads únicos": { es: "Leads únicos" },
  "Próxima etapa": { es: "Siguiente etapa" },
  Avançaram: { es: "Avanzaron" },
  "Taxa de avanço": { es: "Tasa de avance" },
  "Taxa: entre os leads que entraram na etapa, quantos depois entraram na próxima etapa não perdida, dentro do mesmo período. Não é uma previsão nem a divisão dos totais entre colunas. Saltos, retornos e entradas anteriores ao período podem explicar diferenças. Ganhos e perdas são desfechos registrados no período, não o estado atual; um lead reaberto pode aparecer nos dois.": { es: "Tasa: de los leads que entraron en la etapa, cuántos ingresaron después en la siguiente etapa no perdida durante el mismo período. No es una previsión ni la división de los totales entre columnas. Los saltos, retornos y entradas anteriores al período pueden explicar diferencias. Las ganancias y pérdidas son resultados registrados en el período, no el estado actual; un lead reabierto puede aparecer en ambos." },
  "Abrir Kanban para acompanhar e agir": { es: "Abrir Kanban para acompañar y actuar" },
  "Carregando atribuição…": { es: "Cargando atribución…" },
  "Não foi possível carregar a atribuição. Clique em Atualizar para tentar novamente.": { es: "No se pudo cargar la atribución. Haz clic en Actualizar para intentarlo de nuevo." },
  "Cada célula é o número de leads únicos que entraram naquela etapa no período, agrupados pela origem registrada quando o lead nasceu. Um lead pode aparecer em mais de uma etapa.": { es: "Cada celda es la cantidad de leads únicos que entraron en esa etapa durante el período, agrupados por el origen registrado al crear el lead. Un lead puede aparecer en más de una etapa." },
  "UTM source": { es: "Fuente UTM" },
  "UTM campaign": { es: "Campaña UTM" },
  "Referência de anúncio": { es: "Referencia del anuncio" },
  "Título recebido": { es: "Título recibido" },
  "“Referência de anúncio” mostra o identificador capturado no clique, como o CTWA CLID; ele não é o ID interno do anúncio na plataforma. O título só aparece quando veio no payload de origem. Dados sem UTM ou referência ficam agrupados separadamente.": { es: "“Referencia del anuncio” muestra el identificador capturado en el clic, como CTWA CLID; no es el ID interno del anuncio en la plataforma. El título solo aparece cuando llegó en los datos de origen. Los datos sin UTM o referencia se agrupan por separado." },
  "Nenhum funil disponível nesta empresa.": { es: "No hay ningún embudo disponible en esta empresa." },
  "Histórico do funil": { es: "Historial del embudo" },
  "Leads que passaram por cada etapa no período, taxas de avanço e exportação CSV.": { es: "Leads que pasaron por cada etapa durante el período, tasas de avance y exportación CSV." },
  "Quantos leads passaram por cada etapa no período, mesmo que já tenham saído dela.": { es: "Cuántos leads pasaron por cada etapa en el período, aunque ya hayan salido de ella." },
  "Envie para a Meta os avanços importantes do funil e, quando houver uma compra, também o valor da venda. Esse retorno ajuda a plataforma a otimizar as campanhas com base na qualidade real dos contatos.": { es: "Envía a Meta los avances importantes del embudo y, cuando haya una compra, también el valor de la venta. Este retorno ayuda a la plataforma a optimizar las campañas según la calidad real de los contactos." },
  "O envio está pausado. Os eventos continuam sendo registrados aqui, mas não vão para a plataforma enquanto isto estiver desligado.": { es: "El envío está pausado. Los eventos siguen registrándose aquí, pero no se envían a la plataforma mientras esto esté desactivado." },
  "Modo de teste ligado: os eventos vão marcados como teste e não contam para a otimização. Apague o código de teste quando terminar de conferir.": { es: "Modo de prueba activado: los eventos se marcan como prueba y no cuentan para la optimización. Borra el código de prueba cuando termines de verificar." },
  "Eventos que não foram reportados": { es: "Eventos que no fueron reportados" },
  "Nenhuma pendência. Ou tudo que veio de anúncio foi reportado, ou ainda não ocorreu nenhum evento com origem em anúncio.": { es: "No hay pendientes. Todo lo procedente de anuncios fue reportado o todavía no ocurrió ningún evento con origen en anuncios." },
  "Enquanto preenchido, os eventos vão marcados como teste e não contam para a otimização. Apague quando terminar de conferir.": { es: "Mientras esté completo, los eventos se marcan como prueba y no cuentan para la optimización. Bórralo cuando termines de verificar." },
  "Reportar eventos automaticamente": { es: "Reportar eventos automáticamente" },
  "Eventos por etapa do funil": { es: "Eventos por etapa del embudo" },
  "Escolha o sinal enviado quando um negócio entra em cada etapa. Cada evento sai uma única vez por negócio e somente depois de salvar esta configuração.": { es: "Elige la señal enviada cuando un negocio entra en cada etapa. Cada evento se envía una sola vez por negocio y únicamente después de guardar esta configuración." },
  "Não consegui salvar os eventos deste funil.": { es: "No se pudieron guardar los eventos de este embudo." },
  "Eventos do funil salvos. Os próximos movimentos já usam este mapa.": { es: "Eventos del embudo guardados. Los próximos movimientos ya usan este mapa." },
  "Deixe o evento vazio quando a etapa não deve ensinar nada à plataforma.": { es: "Deja el evento vacío cuando la etapa no deba enseñar nada a la plataforma." },
  "Evento enviado": { es: "Evento enviado" },
  "Nenhum evento": { es: "Ningún evento" },
  "Exigir valor": { es: "Exigir valor" },
  "O que é um lead qualificado?": { es: "¿Qué es un lead cualificado?" },
  "Descreva perfil, necessidade, orçamento, região e demais critérios.": { es: "Describe perfil, necesidad, presupuesto, región y demás criterios." },
  "O que desqualifica um lead?": { es: "¿Qué descalifica a un lead?" },
  "Descreva impedimentos e sinais objetivos de desqualificação.": { es: "Describe impedimentos y señales objetivas de descalificación." },
  ...
  "Esta ação não pode ser desfeita. Apaga os dados desta organização, incluindo leads, conversas, relatórios e credenciais. Outros tenants e contas de login não serão excluídos. Remova as sessões de WhatsApp e desconecte as integrações antes de continuar.": { es: "Esta acción no se puede deshacer. Elimina los datos de esta organización, incluidos leads, conversaciones, informes y credenciales. No se eliminarán otros tenants ni cuentas de acceso. Quita las sesiones de WhatsApp y desconecta las integraciones antes de continuar." },
  "Motivo da exclusão (mínimo 10 caracteres)": { es: "Motivo de la eliminación (mínimo 10 caracteres)" },
  ...
  "Bloquear módulo de IA": { es: "Bloquear módulo de IA" },
  "Liberar módulo de IA": { es: "Habilitar módulo de IA" },
  "Configure a organização pelo acompanhamento ou pelo seletor de organizações. Depois marque a implantação como concluída.": { es: "Configura la organización mediante el acompañamiento o el selector de organizaciones. Después marca la implementación como finalizada." },
  "Concluir implantação": { es: "Finalizar implementación" },
  "Sua organização principal — protegida contra exclusão.": { es: "Tu organización principal, protegida contra eliminación." },
  "Defina sua organização principal antes de excluir qualquer tenant.": { es: "Define tu organización principal antes de eliminar cualquier tenant." },
  "Esta é uma organização de cliente, não a principal.": { es: "Esta es una organización de cliente, no la principal." },
  ...
  "será sua única organização principal e não poderá ser excluída. Se já houver outra principal, ela deixará de ter essa proteção. Nenhum dado será apagado.": { es: "será tu única organización principal y no podrá eliminarse. Si ya existe otra principal, dejará de tener esa protección. No se borrará ningún dato." },
  "Confirmar organização principal": { es: "Confirmar organización principal" },
  "Lead movido no funil.": { es: "Lead movido en el embudo." },
  "Mover lead para etapa": { es: "Mover lead a la etapa" },
  "Movendo…": { es: "Moviendo…" },
  "Não há etapas disponíveis neste funil.": { es: "No hay etapas disponibles en este embudo." },
  "Lead encerrado: abra uma nova oportunidade para movê-lo.": { es: "Lead cerrado: abre una nueva oportunidad para moverlo." },
  "Etapa atual": { es: "Etapa actual" },
  "Origem do lead": { es: "Origen del lead" },
  "Analisar qualificação com IA": { es: "Analizar cualificación con IA" },
  "Ajuda da IA para qualificar": { es: "Ayuda de la IA para cualificar" },
  "A IA apenas sugere. Você confirma movendo o card para a etapa adequada; só esse gesto humano pode disparar o evento da Meta.": { es: "La IA solo sugiere. Tú confirmas moviendo la tarjeta a la etapa adecuada; solo ese gesto humano puede activar el evento de Meta." },
  "A análise compara a conversa com os critérios definidos para este funil.": { es: "El análisis compara la conversación con los criterios definidos para este embudo." },
  "Critérios encontrados": { es: "Criterios encontrados" },
  "Informações ausentes": { es: "Información ausente" },
