 ...
 */
const LEAD_COLS =
  "id, title, status, value_cents, currency, updated_at, pipeline_id, stage_id, position_in_stage, source, source_metadata, custom_fields, crm_pipelines!inner(name, settings, is_archived), crm_stages(name)";
